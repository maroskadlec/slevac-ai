          ...
          {isOpen && (
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-[24px] pb-[8px] flex flex-col gap-[12px] min-h-0 bg-white">
                {/* Welcome Title */}
                <h2 className="text-[32px] leading-[38px] font-heading font-bold text-black pt-[4px] pb-[4px] text-center">
                ...
                {chat.messages.map((msg) => (
                  ...
                  >
                    {msg.sender === 'user' ? (
                      <div className="bg-[#E5F0F7] rounded-[16px] rounded-br-[4px] px-[14px] py-[8px] max-w-[80%]">
